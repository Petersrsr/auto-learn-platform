...
function processReturn($order, $api_trade_no=null, $buyer=null, $bill_trade_no = null){
	\lib\Payment::processOrder(false, $order, $api_trade_no, $buyer, $bill_trade_no);
}

function processNotify($order, $api_trade_no=null, $buyer=null, $bill_trade_no = null){
	\lib\Payment::processOrder(true, $order, $api_trade_no, $buyer, $bill_trade_no);
}
...
function get_alipay_userid(){
	...
	return alipay_oauth($alipay_config);
}

function alipay_oauth($alipay_config){
	global $conf;
	try{
